WeibullAnalysis MATLAB .NET Assembly (.NET Component)
...
WeibullAnalysis_overview.html - HTML overview documentation file for the generated 
                                component. It contains the requirements for accessing the 
                                component and for generating arguments using the MWArray 
                                class hierarchy.

WeibullAnalysis.xml - This file contains the code comments for the WeibullAnalysis 
                                ...
                                documentation for the WeibullAnalysis component.
